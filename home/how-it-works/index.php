...
<body>
  ...
  <header style="padding-top: 0; margin-top: 0;">
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbarContent">
          <ul class="navbar-nav ml-lg-4 pt-3 pt-lg-0">
            ...
            <li class="nav-item">
              <a href="#" id="activer" class="nav-link">How it works</a>
            </li>
            <li class="nav-item">
    ...
    <div class="page-banner home-banner" style="background:#f2fbff;">
      <div class="container h-100">
        <div class="row align-items-center h-100">
          <div class="col-lg-6 py-3 wow fadeInUp">
            <h1 class="mb-4" style="font-weight: bold; font-size: 37px; line-height: 1.3;">How It Works</h1>
          ...
          <div class="col-lg-6 py-3 wow zoomIn">
            <div class="img-place">
              <img src="../assets/img/sideds.png" alt="">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 py-3 pr-lg-5">
            <h2 class="title-section">Launch your business in 4 easy steps</h2>
            <div class="divider"></div>
            <p style="font-size: 18px;"><b><i class="fa-solid fa-arrow-right" style="color: #700FDC;"></i> Create/Upload Your Design.</b></p><br>
            <p style="font-size: 18px;"><b><i class="fa-solid fa-arrow-right" style="color: #700FDC;"></i> Choose your Platforms.</b></p><br>
            <p style="font-size: 18px;"><b><i class="fa-solid fa-arrow-right" style="color: #700FDC;"></i> Customize your Storefront.</b></p><br>
            <p style="font-size: 18px;"><b><i class="fa-solid fa-arrow-right" style="color: #700FDC;"></i> Publish and Start Selling.</b></p><br>
          </div>
          <div class="col-lg-6 py-3">
            <div class="img-fluid text-center">
              <img src="../assets/img/howto.jpg" width="80%" alt="">
            </div>
          </div>
