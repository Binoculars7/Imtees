...
<body>
  ...
  <header style="padding-top: 0; margin-top: 0;">
    <nav class="navbar navbar-expand-lg navbar-light navbar-float" style="box-shadow: none; font-weight: bold; background:#F9FDFF; margin-top:-1em;">
      <div class="container">
        <a href="index.html" class="navbar-brand"><img src="assets/img/logo.png" width="40"></a>
        ...
        <div class="navbar-collapse collapse" id="navbarContent">
          <ul class="navbar-nav ml-lg-4 pt-3 pt-lg-0">
            <li class="nav-item">
              <a href="#" id="activer" class="nav-link">Home</a>
            </li>
            <li class="nav-item">
          ...
          <?php
            if ($_SESSION['email'] != 0) {
              echo '<a href="../store/dashboard/" class="btn btn-primary" style="padding: 0.4em 1.8em; border-radius: 12px;"><small><span class="mai-rocket-outline"></span> Create Now</small></a>';
            }else{
      ...
      <div class="container h-100">
        <div class="row align-items-center h-100">
          <div class="col-lg-6 py-3 wow fadeInUp">
            <h1 class="mb-4" style="font-weight: bold; font-size: 37px; line-height: 1.3;">Bring Your Designs to Life with Seamless Shop Integration</h1>
            ...
            <?php
            if ($_SESSION['email'] != 0) {
              echo '<a href="../store/dashboard/" class="btn btn-primary ml-2" style="border-radius: 11px;"><span class="mai-rocket"></span> Create Now </a>';
            }else{
          ...
          <div class="col-lg-6 py-3 wow zoomIn">
            <div class="img-place">
              <img src="assets/img/sided.png" alt="">
            </div>
          </div>
        </div>
      </div>
...
<br>
    <div class="page-section client-section">
          <div class="item wow zoomIn" style="background: #f9f9f9; padding: 2em 0;">
            ...
            <img src="assets/img/company.PNG" alt="" style="width: 60%; margin-top: 1em;">
        </div>
<!-- .container-fluid -->
    </div> <!-- .page-section -->
    ...
    <div class="page-section" style="margin-top: -1em;">
      <div class="container">
        ...
        <div id="flexer" style="text-align: center; display: flex; margin: auto;">
          ...
          <br>  <br><div><img src="assets/img/icon1.PNG" width="80" alt=""></div>
          ...
          <div style="background: #F8F1FF; border-radius: 20px;  padding:0.4em 0; margin-left: 1em; margin-right: 1em; margin-top: 2em;">
            <br><br><div><img src="assets/img/icon2.PNG" width="80" alt=""></div>
          ...
          <div style="background: #F8F1FF; border-radius: 20px;  padding:0.4em 0; margin-left: 1em; margin-right: 1em; margin-top: 2em;">
           <br><br> <div><img src="assets/img/icon3.PNG" width="80" alt=""></div>
    ...
    <div class="page-section client-section">
      <div class="item wow zoomIn" style="background:#ffffff; padding: 2em 0;">
        ...
        <img src="assets/img/stuffs.png" alt="" style="width: 70%; margin-top: 1em;">
    </div>
<!-- .container-fluid -->
</div> <!-- .page-section -->
        ...
        <div class="row my-5 card-blog-row">
          <div class="col-md-6 col-lg-3 py-3 wow fadeInUp">
            <div class="card-blog" style="text-align: center; border: 1px solid rgb(172, 167, 167); box-shadow: none; padding-top: 0; padding-bottom: 0em; background: none; overflow: hidden; position: relative;">
              <img src="assets/img/cloth1.png" width="420px" height="280px" alt="" style="margin-left: -6.5em;">
            </div>
          ...
          <div class="col-md-6 col-lg-3 py-3 wow fadeInUp">
            <div class="card-blog" style="text-align: center; border: 1px solid rgb(172, 167, 167); box-shadow: none; padding-top: 0; padding-bottom: 0em; background: none; overflow: hidden; position: relative;">
              <img src="assets/img/cloth2.png" width="420px"  height="280px" alt="" style="margin-left: -6em;">
            </div>
            <div class="cart-section">
              <div style="margin-top: 0.3em;">
                <div style="font-size: 13px;">Round Neck</div>
          ...
          <div class="col-md-6 col-lg-3 py-3 wow fadeInUp">
            <div class="card-blog" style="text-align: center; border: 1px solid rgb(172, 167, 167); box-shadow: none; padding-top: 0; padding-bottom: 0em; background: none; overflow: hidden; position: relative;">
              <img src="assets/img/cloth3.jpg" width="200px"  height="280px" alt="">
            </div>
            <div class="cart-section">
              <div style="margin-top: 0.3em;">
          ...
          <div class="col-md-6 col-lg-3 py-3 wow fadeInUp">
            <div class="card-blog" style="text-align: center; border: 1px solid rgb(172, 167, 167); box-shadow: none; padding-top: 0; padding-bottom: 0em; background: none; overflow: hidden; position: relative;">
              <img src="assets/img/cloth4.png" width="400px"  height="280px" alt="" style="margin-left: -6.5em;">
            </div>
            <div class="cart-section">
              <div style="margin-top: 0.3em;">
                <div style="font-size: 13px;">Hoodie</div>
